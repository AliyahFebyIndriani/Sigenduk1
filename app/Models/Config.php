    ...
    public static function boot()
{
    ...
    // Filter otomatis setiap query berdasarkan kode_desa di session
    static::addGlobalScope('desa_aktif', function ($builder) {
        $CI =& get_instance();
        $kode_aktif = $CI->session->userdata('kode_desa_aktif');
        
        if ($kode_aktif) {
            $builder->where('kode_desa', $kode_aktif);
        }
    });
